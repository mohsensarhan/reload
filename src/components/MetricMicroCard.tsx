...
import { Area, AreaChart, ResponsiveContainer, Line, LineChart, Tooltip as RechartsTooltip } from 'recharts';
        ...
        <CardContent className="p-4 h-full flex flex-col">
          ...
          <div className="flex-1 min-h-[80px] mb-2">
            {chartData.length > 0 ? <ResponsiveContainer width="100%" height="100%">
                {chart === 'area' ? <AreaChart data={chartData} key={animationKey}>
                    <defs>
                    ...
                    />
                  </AreaChart> : <LineChart data={chartData} key={animationKey}>
                    <RechartsTooltip content={<CustomTooltip />} />
                    <Line 
                      type="monotone" 
                      dataKey="value" 
          ...
          {/* Data Source */}
          {dataSource && <div className="mb-2 text-center">
          ...
          {/* Footnote */}
          {footnote && <div className="text-xs text-muted-foreground leading-tight">
              {footnote}
            </div>}
        </CardContent>
      </Card>
